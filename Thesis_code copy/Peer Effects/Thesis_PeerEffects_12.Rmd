...
peereffects_no_fe <- lm(total_math_reading_2 ~ total_math_reading_1 + prop_leavers + leaver_mean + leaver_variance + prop_leavers * leaver_mean + prop_leavers * leaver_variance + as.factor(g1classtype) + as.factor(g2classtype) + leave_one_out_avg1 + leave_one_out_avg2 + as.factor(race) + as.factor(gender) + as.factor(g1freelunch) + as.factor(g2freelunch) + g1absent + as.factor(g1speced) + as.factor(g1specin) + as.factor(g2trace) + as.factor(g2t_masters) + g2tyears + as.factor(g1trace) + as.factor(g1t_masters) + g1tyears + as.factor(g2surban) + as.factor(grdrange) + g2_fl + g2_bus + g1_fl + g1_bus, data = peereffect_12_reg_data)
 

peereffects_with_fe <- plm(total_math_reading_2 ~ total_math_reading_1 + prop_leavers + leaver_mean + leaver_variance + prop_leavers * leaver_mean + prop_leavers * leaver_variance + as.factor(g1classtype) + as.factor(g2classtype) + leave_one_out_avg1 + leave_one_out_avg2 + as.factor(race) + as.factor(gender) + as.factor(g1freelunch) + as.factor(g2freelunch) + g1absent + as.factor(g1speced) + as.factor(g1specin) + as.factor(g2trace) + as.factor(g2t_masters) + g2tyears + as.factor(g1trace) + as.factor(g1t_masters) + g1tyears + as.factor(g2surban) + as.factor(grdrange) + g2_fl + g2_bus + g1_fl + g1_bus, data = peereffect_12_reg_data,
                    index = c("g1schid"), 
                    model = "within")

peereffects_with_fe_mathscore <- plm(g2tmathss ~ total_math_reading_1 + prop_leavers + leaver_mean + leaver_variance + prop_leavers * leaver_mean + prop_leavers * leaver_variance + as.factor(g1classtype) + as.factor(g2classtype) + leave_one_out_avg1 + leave_one_out_avg2 + as.factor(race) + as.factor(gender) + as.factor(g1freelunch) + as.factor(g2freelunch) + g1absent + as.factor(g1speced) + as.factor(g1specin) + as.factor(g2trace) + as.factor(g2t_masters) + g2tyears + as.factor(g1trace) + as.factor(g1t_masters) + g1tyears + as.factor(g2surban) + as.factor(grdrange) + g2_fl + g2_bus + g1_fl + g1_bus, data = peereffect_12_reg_data,
                    index = c("g1schid"), 
                    model = "within")

peereffects_with_fe_readscore <- plm(g2treadss ~ total_math_reading_1 + prop_leavers + leaver_mean + leaver_variance + prop_leavers * leaver_mean + prop_leavers * leaver_variance + as.factor(g1classtype) + as.factor(g2classtype) + leave_one_out_avg1 + leave_one_out_avg2 + as.factor(race) + as.factor(gender) + as.factor(g1freelunch) + as.factor(g2freelunch) + g1absent + as.factor(g1speced) + as.factor(g1specin) + as.factor(g2trace) + as.factor(g2t_masters) + g2tyears + as.factor(g1trace) + as.factor(g1t_masters) + g1tyears + as.factor(g2surban) + as.factor(grdrange) + g2_fl + g2_bus + g1_fl + g1_bus, data = peereffect_12_reg_data,
                    index = c("g1schid"), 
                    model = "within")
```
